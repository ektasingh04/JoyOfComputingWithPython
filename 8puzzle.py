...
# Importing the heap for Priority Queue
from heapq import heappush, heappop

# This variable can be changed to change the program from 8 to 15 to 24 
n = 3
...
# Function to calculate the number of misplaced tiles ie. number 
#  of non-blank tiles not in their goal position
...
# empty_tile_pos is blank tile position in the initial state.
def solve(initial, empty_tile_pos, final):
	...
	while not pq.empty():
		...
		# cost and delete it from the list of live nodes
		minimum = pq.pop()
